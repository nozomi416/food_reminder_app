    ...
    <div class="flex justify-center">
        <div
            ...
            <form class="space-y-6" @submit.prevent="login">
                <h5 class="text-center text-2xl font-bold text-orange-500">ログイン</h5>
                ...
                <button type="submit"
                    class="w-full text-white bg-orange-400 font-medium rounded-lg mt-1 px-5 py-3 text-center">ログイン</button>
            </form>
            <div class="font-medium mt-4 flex flex-col gap-1">
                <router-link to="/signup" class="text-center text-orange-500">アカウントを作成する</router-link>
            </div>
        </div>
    </div>
</template>
